    ...
    <footer className="bg-primary my-4 text-center text-white dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      ...
      >
        ...
        <div className="flex justify-center items-center">
          <Link className="mr-6 text-white dark:text-neutral-200">
            <svg
      ...
      >
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="md:block">
            <h6 className="mb-4 text-yellow-600 flex items-center justify-center font-semibold uppercase md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <div className="grid grid-cols-2 md:pl-16 md:col-span-2">
            <div className="">
              <h6 className="mb-4 text-yellow-600 flex justify-center font-semibold uppercase md:justify-start">
                ভিজিট করুন
              </h6>
              <p className="mb-4">
            ...
            <div className="">
              <h6 className="mb-4 flex text-yellow-600 justify-center font-semibold uppercase md:justify-start">
                আরো দেখুন
              </h6>
              <p className="mb-4">
          ...
          <div className="md:block hidden">
            <div className="text-center">
              <h6 className="mb-4 py-3 text-yellow-600 rounded-md flex justify-center font-semibold uppercase md:justify-start">
                যোগাযোগ
              </h6>
            </div>
