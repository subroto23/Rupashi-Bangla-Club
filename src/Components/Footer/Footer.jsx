  ...
  return (
    <div className="mt-8">
      <footer className="bg-primary text-center text-white dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        <div className="flex border-b-2 border-neutral-200 dark:border-neutral-500 lg:justify-between py-4">
          ...
          <div className="flex justify-center items-center">
            ...
            <a className="text-white dark:text-neutral-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 md:w-4 md:block hidden"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="grid grid-cols-2 md:pl-16 md:col-span-2">
              <div className="">
                ...
                <p className="mb-4">
                  <a className="text-white dark:text-neutral-200">খবর</a>
                </p>
                <p className="mb-4">
                  <a className="text-white dark:text-neutral-200">শিক্ষা</a>
                </p>
                <p className="mb-4">
                  <a className="text-white dark:text-neutral-200">খেলাধুলা</a>
                </p>
                <p>
                  <a className="text-white dark:text-neutral-200">সেবাসমূহ</a>
                </p>
              </div>
              ...
              <div className="">
                ...
                <p className="mb-4">
                  <a className="text-white dark:text-neutral-200">ছবি</a>
                </p>
                <p className="mb-4">
                  <a className="text-white dark:text-neutral-200">ভিডীও</a>
                </p>
                <p className="mb-4">
                  <a className="text-white dark:text-neutral-200">
                    ক্লাব সদস্য
                ...
                <p>
                  <a className="text-white dark:text-neutral-200">গ্রামবাসী</a>
                </p>
              </div>
            </div>
            {/* <!-- Contact section --> */}
            <div className="md:block hidden">
              <h6 className="mb-4 bg-[#5362ff] py-3 rounded-md flex justify-center font-semibold uppercase md:justify-start">
                যোগাযোগ
              </h6>
        ...
        {/* <!--Copyright section--> */}
        <div className="bg-blue-800 p-6 text-center dark:bg-neutral-700">
